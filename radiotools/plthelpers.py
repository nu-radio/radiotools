...
def fplanckfreqcmap():
    ...
    from https://github.com/astrosica/misc-functions/
    '''

    planck_cmap = ListedColormap(np.loadtxt(os.path.join(os.path.dirname(__file__), "data/Planck_FreqMap_RGB.txt"))/255.)
...
def fplanckparchmentcmap():
    ...
    planck_cmap = ListedColormap(np.loadtxt(os.path.join(os.path.dirname(__file__), "data/Planck_Parchment_RGB.txt"))/255.)
    planck_cmap.set_bad("gray")    # color of missing pixels
    planck_cmap.set_under("white") # color of background, necessary if you want to use with mollview
